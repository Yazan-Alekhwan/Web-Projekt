...
if(isset($_POST['email'])){
    ...
    $sql="select * from kunde where email='".$email."' AND passwort='". md5($psw)."' And ist_Admin = false limit 1";
...
<body>
  ...
  <form action="anmelde.php" method="post">
  ...
  <div class="container">
    ...
    <a href="AdminAnmeldung.php"> Sind Sie Admin? </a>
